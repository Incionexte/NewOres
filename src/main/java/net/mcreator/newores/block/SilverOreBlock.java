...
public class SilverOreBlock extends NewOresModElements.ModElement {
	@ObjectHolder("new_ores:silver_ore")
	public static final Block block = null;
	public SilverOreBlock(NewOresModElements instance) {
		super(instance, 22);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("new_ores:silver_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_ores:silver_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
