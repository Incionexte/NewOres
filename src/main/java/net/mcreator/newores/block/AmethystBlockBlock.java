...
import net.mcreator.newores.item.AmethystGemItem;
...
public class AmethystBlockBlock extends NewOresModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("new_ores:amethyst_block_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 6)).range(54)
					.square().func_242731_b(3);
			event.getRegistry().register(feature.setRegistryName("amethyst_block"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_ores:amethyst_block"), configuredFeature);
		}
	}
	@SubscribeEvent
